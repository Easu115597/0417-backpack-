...
def parse_arguments():
    ...
    martingale_group.add_argument("--entry-type", type=str, default="offset", choices=["manual", "market", "offset"], help="首單下單方式: manual (指定價格), market (市價), offset (低於現價)")
    martingale_group.add_argument("--entry-price", type=float, default=None, help="entry-type 為 manual 時必填：首筆入場價格")
